...
task1();
    ...
    public static void task1 () {
        ...
        System.out.println("Teenager1.getAuthor() = " + Teenager1.getAuthor() + " " + Teenager1.getAuthorSurname());
        Book Auditor = new Book("Ревизор", 1836);
        Author Auditor1 = new Author("Николай", "Гоголь");
        System.out.println("Auditor.getNameBook() = " + Auditor.getNameBook());
        System.out.println("Auditor.getAge() = " + Auditor.getAge());
        System.out.println("Auditor1.getAuthor() = " + Auditor1.getAuthor() + " " + Auditor1.getAuthorSurname());
